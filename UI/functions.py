...
def main_function(file_name1, file_name2, no):
    ...
    # Nearest Neighbor Interpolation 
        ...
        img_int = cv2.resize(img,(384,384),fx=0,fy=0, interpolation = cv2.cv2.INTER_NEAREST)
    ...
    label_msssim = Label(top, text = "MS-SSIM: "+str(msssim_img), bg="#333333", fg="#fff")
    label_msssim.grid(row=2, column=0)
