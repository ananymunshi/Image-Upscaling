...
if __name__ == '__main__':
    ...
    def arguments(ref, img):
        ref = prepare_image(Image.open(ref).convert("RGB"))
        dist = prepare_image(Image.open(img).convert("RGB"))
    ...
    # arguments(r"D:\image_upscaling\Data\HR\0.png", r"D:\image_upscaling\0.png")
        # score: 0.3347
else:
    from PIL import Image
    def arguments(ref, img):
